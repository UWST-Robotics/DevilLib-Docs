...
<Tabs groupId="odometry-method">
    ...
    <TabItem value="drivetrain" label="Drivetrain Encoder" default>
        ...
        // Define the width of the drivetrain (in inches)
        ...
        MyRobot()
        {
            ...
            //odom.useIMU(&imu);             // <-- Uncomment to use an IMU for odometry
    ...
    <TabItem value="deadwheels" label="Dead Wheels" default>
    </TabItem>
</Tabs>
