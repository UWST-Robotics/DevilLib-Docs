...
<Tabs groupId="feedforward">
    ...
    <TabItem value="arm" label="Arm">
        ...
        For example, when the arm is all the way down or all the way up, the force of gravity is negated by the mechanism's internal structure.
        When the arm motor is fully horizontal, the arm motor(s) have to fight against the maximum amount of gravity.
